...
public class TestMain
{
	...
	public static void main(String[] args)
	{
		...
		ComputeMutualAcceleration cf = new ComputeMutualAcceleration(0, 1, im,map);
		cf.run();
		System.out.println(pl.toString());
		System.out.println("-------------------------");
		System.out.println(im.toString());
		ComputeNewPosition cp1 = new ComputeNewPosition(0,map.getPosition(0), 2, im,newMap);
		ComputeNewPosition cp2 = new ComputeNewPosition(1,map.getPosition(1), 1, im,newMap);
		cp1.run();
		cp2.run();
		System.out.println(pl.toString());
		System.out.println("-------------------------");
